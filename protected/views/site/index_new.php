                            ...
                            <?php foreach ($newLists as $list): ?>
                                <div class="col-sm-6 col-md-4 col-md-3">
                                    <div class="card">
                                        ...
                                        <img class="card-img-top" src="<?= $listUrl . $list->getImage() ?>"
                                             alt="<?= $list->title ?>">
                                        <div class="card-body">
                            ...
                            <div class="col-md-8 col-lg-6">
                                <div class="text-center">
                                    <video class="img-fluid" controls
                                           poster="./assets/media/images/home/slider/p-2.png">
                                    ...
                                    <?php foreach ($lastEvents as $event): ?>
                                        <li>
                                            <div class="d-flex align-items-center align-items-lg-baseline">
                                                <div>
                                                    <?php if ($event->user): ?>
                                                        <a href="void:;" class="-text-blue"><img
                                                                    src="<?= $event->user->userDetails->getAvatar() ?>"
                                                                    alt=""></a>
                                                    <?php else: ?>
                                                        <a href="void:;" class="-text-blue"><img
                                                                    src="<?= Yii::app()->theme->baseUrl . '/media/images/public/user_avatar.png' ?>"
                                ...
                                <div class="reports__itemContainer text-center mb-5 mb-md-0">
                                    <a class="list">
                                        ...
                                        <div class="counter--container">
                                            <h2 class="-h2 counter"><?= number_format($statistics['lists']) ?></h2>
                                ...
                                <div class="reports__itemContainer text-center mb-5 mb-md-0">
                                    <a class="user">
                                        <img class="img-fluid"
                                             ...
                                             alt="">
                                        <div class="counter--container">
                                            <h2 class="-h2 counter"><?= number_format($statistics['users']) ?></h2>
                                ...
                                <div class="reports__itemContainer text-center mb-5 mb-md-0">
                                    <a class="vote">
                                        <img class="img-fluid"
                                             ...
                                             alt="">
                                        <div class="counter--container">
                                            <h2 class="-h2 counter"><?= number_format($statistics['votes']) ?></h2>
